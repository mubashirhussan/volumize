    ...
    <div>
      ...
      <div className="primary-container">
        <div className="grid grid-cols-12 px-5 py-5">
          <div className="col-span-5 py-5 justify-center">
            <Image src={IMAGES.PROCESS1} alt="readmore" />
          </div>
          <div className="col-span-7">
            ...
            <p className=" text-[18px] text-[#7E7E7E] font-sans font-normal">
              For many, hair loss feels inevitable. A lot of men decide to
              embrace the change, either by overlooking the transformation or
              confidently rocking a bald look. However, some find this change
              hard to accept, grappling with the unfamiliar and unwanted shift
              in their appearance.
            </p>
            ...
            <p className="py-4 text-[18px] text-[#7E7E7E] font-sans font-normal">
              ...
              Topical Finasteride. The primary function of Finasteride is to
              halt the transformation of Testosterone into DHT. Another vital
              solution is Minoxidil. This topical remedy helps nourish the hair
              follicles, amplifying hair thickness and enlarging their size.
            </p>
            <h3 className="text-[22px] text-[#005C9E] font-sans font-bold py-4">
              The Volumize Solution
            </h3>
            <p className=" text-[18px] text-[#7E7E7E] font-sans font-normal">
              We've merged the strengths of Finasteride and Minoxidil to craft
              the optimal hair loss solution. Our spray and capsule is
              effortlessly applied without leaving your hair looking oily or
              drenched, an issue commonly associated with some other products.
            </p>
          </div>
        </div>
      </div>
